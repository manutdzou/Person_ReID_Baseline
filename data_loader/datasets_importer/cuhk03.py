...
class CUHK03(BaseImageDataset):
    ...
    def __init__(self, cfg, split_id=0, cuhk03_labeled=False,
        ...
        self.raw_mat_path = os.path.join(self.dataset_dir, 'cuhk-03.mat')
            ...
            for i, (campid, pid, img_paths) in enumerate(meta_data):
                ...
                if [campid, pid] in test_split:
                    for img_path in img_paths:
                        camid = int(os.path.basename(img_path).split('_')[2]) - 1  # make it 0-based
